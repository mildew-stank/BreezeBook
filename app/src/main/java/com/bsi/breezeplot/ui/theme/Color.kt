...
// Calm Water
val DarkBlue = Color(0xff254151) // background
...
val Blue900 = Color(0xff214159) // surface (buttons and alert background)
val Blue700 = Color(0xff255a7f) // outline (card lines)
...
val Monochrome900 = Color(0xff3d3d3d) // surface (buttons and alert background)
val Monochrome700 = Color(0xff4f4f4f) // outline (card lines)
val Monochrome500 = Color(0xff6d6d6d) // onBackground (label text)
val Monochrome300 = Color(0xffb0b0b0) // onSurface (button text)
val Monochrome100 = Color(0xffe7e7e7) // tertiary (segment lines)
val Monochrome50 = Color(0xfff6f6f6) // secondary (date and pins)
val Monochrome0 = Color(0xffffffff) // primary (data text)
